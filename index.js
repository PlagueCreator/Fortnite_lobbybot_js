...
(async () => {
  ...
  if (currentLibVersion !== latestVersion) console.log('\x1b[31mWARNING: Stai\usendo una vecchia versione della libreria, per favore clicca installDependencies.bat\x1b[0m');
  let config;
  try {
